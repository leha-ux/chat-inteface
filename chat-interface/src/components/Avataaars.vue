      ...
      <g
        ...
        <template v-if="isCircle">
          ...
          <g
            ...
            <svg :style="cssVars" v-html="eyeTypes[eyeTypeValue]"></svg>
...
import { eyeColors, hairColors, skinColors, hatAndShirtColors } from '../assetsTypes/colors'
...
export default {
     props: {
        ...
        eyeColor: { type: String, default: 'random' },
    ...
    computed: {
        cssVars () {
          return {
            ...
            '--avataaar-eye-color': this.eyeColor === 'random' ? this.getRandomChoice(this.eyeColors) : this.eyeColors[this.eyeColor],
